...
<!-- Page content -->
<div id="page-content">
   <form id="form-validation" action="<?php echo base_url();?>admin/update_brand" method="post" class="form-horizontal" enctype="multipart/form-data">
      <div class="row">
         <div class="col-sm-12 col-lg-12 margin-bottom">
            <div class="row">
               <div class="col-sm-9">
                  <h3 class="remove-margin"> <i class="fa fa-cube fa-fw"></i> Edit Brand</h3>
               </div>
      ...
      <div class="row">
         <div class="col-sm-12">
            ...
            <div class="row">
               <div class="col-sm-3">
                  <h5 class="remove-margin"><b>Brands Detail </b></h5>
                  <p>Write a name and description and upload image for this brand.</p>
               </div>
               <div class="col-sm-9">
            ...
            <div class="row">
               <div class="col-sm-3">
                  ...
                  <p>Control if this brand can be viewed on frontend.</p>
               </div>
               <div class="col-sm-9">
                  <div class="form-group">
                     <div class="col-xs-12">
