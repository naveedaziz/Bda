            ...
            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td> <a href="<?php echo base_url().'admin/edit_banner/'.$row->id; ?>"> <?php echo $row->title; ?> </a></td>
                     <td><?php if($row->description){ echo substr($row->description, 0, 50).'...';}else{ echo '&nbsp;' ;} ?></td>
                     <td class="text-center">
                        <a href="<?php echo base_url().'admin/change_banner_status/'.$row->id.'/'.$row->status; ?>" class="no_underline">
                     ...
                     <td class="text-center">
                        <div class="btn-group">
                           <a href="<?php echo base_url().'admin/edit_banner/'.$row->id; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
