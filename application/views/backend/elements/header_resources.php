...
<html class="no-js lt-ie9">
   ...
   <html lang="en" class="no-js">
      ...
      <head>
         ...
         <link rel="stylesheet" type="text/css" href="<?php echo base_url().ASSETS_ADMIN_CSS_DIR;?>bootstrap.min.css">
         ...
         <!-- The demo_table stylesheet of this template for datatables. -->
         <!-- END Stylesheets -->
