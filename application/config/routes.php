...
$route['frontend/getBrands'] = 'frontend/home/getBrand';
$route['frontend/brands'] = 'frontend/home/getAllBrands';
$route['frontend/brands:any'] = "frontend/home/getAllBrands";
$route['frontend/brand_detail:any'] = "frontend/home/getBrandDetail";
...
$route['frontend/thanks'] = 'frontend/home/thanks';
...
* Admin routes
*/
$route['admin/index:any'] = "backend/admin/index";
$route['admin']	= "backend/admin/index";
$route['admin/index'] = "backend/admin/index";
$route['admin/doLogin'] = "backend/admin/doLogin";
$route['admin/update_password'] = "backend/admin/updatePassword";
$route['admin/update_password_admin'] = "backend/admin/updatePasswordAdmin";
$route['admin/resetPassword'] = "backend/admin/resetPassword";
$route['admin/unauthorized'] = "backend/admin/unauthorized";

$route['admin/query'] = "backend/admin/query";
$route['admin/query_detail:any'] = "backend/admin/query_detail";
$route['admin/exportUsers'] = "backend/admin/exportUsers";
$route['admin/exportQuery:any'] = "backend/admin/exportSingleQuery";
