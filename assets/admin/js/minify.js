...
var App = function() {
    ...
    var u = function() {
        ...
        $(window).bind("orientationchange", h);
        var u = $("#year-copy"),
            l = new Date;
        if (l.getFullYear() === 2014) {
            u.html("2014")
        } else {
            u.html("2014-" + l.getFullYear().toString().substr(2, 2))
        }
        v();
    ...
    var a = function() {
        ...
        var t = 250;
        var n = $(".sidebar-nav a");
        var r = $(".sidebar-nav-menu");
        var i = $(".sidebar-nav-submenu");
        r.click(function() {
            var n = $(this);
        ...
        if (t === "init") {
            ...
            if (t === "toggle-sidebar") {
                ...
                if (o.length && !o.parent(".slimScrollDiv").length) {
                    ...
                    $(window).resize(l);
                    $(window).bind("orientationchange", c)
                }
            }
        }
        return false
    ...
    var m = function() {
        ...
        var l = $("#options-header-top");
        var c = $("#options-header-bottom");
        ...
        var p = $("#options-footer-static");
        var d = $("#options-footer-fixed");
        if (e.hasClass("footer-fixed")) {
            d.addClass("active")
        } else {
            p.addClass("active")
...
window.onload = function() {
    if (window.File && window.FileList && window.FileReader) {
        ...
        if (e) e.addEventListener("change", function(e) {
        ...
        var t = document.getElementById("filesBanner");
...
function check(input) {
    if (input.value != document.getElementById('password').value) {
        input.setCustomValidity('Password and confirm password must match.');
    } else {
