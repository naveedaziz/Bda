<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $config['smtp_user']='hosting@bramerz.pk';
    $config['smtp_pass']='7ii6IGXZpI5psIJ2qihy2w';
...
class CI_Email {
	...
	var	$useragent		= "Nestle Pure Life";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "mail";	// mail/sendmail/smtp
	var	$smtp_host		= "ssl://smtp.mandrillapp.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "hosting@bramerz.pk";		// SMTP Username
	var	$smtp_pass		= "7ii6IGXZpI5psIJ2qihy2w";		// SMTP Password
